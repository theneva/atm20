        ...
        return r.each(function ()
        {
            ...
            i = {
                ...
                }, initializeHistory: function ()
                {
                    if (s.history)
                    {
                        if (i.debug("Initializing page state"), e.address === n)
                        {
                            return i.error(x.state), !1;
                        }
                        if ("state" == s.historyType)
                        {
                            if (i.debug("Using HTML5 to manage state"), s.path === !1)
                            {
                                return i.error(x.path), !1;
                            }
                ...
                }, changeTab: function (n)
                {
                    ...
                    n = i.utilities.arrayToPath(u), e.each(u, function (t, o)
                    {
                        ...
                        {
                            if (i.verbose("Tab was found", o), p = v, h = i.utilities.filterArray(u, f), T ? g = !0 : (d = u.slice(0, t + 2), b = i.utilities.arrayToPath(d), g = !i.is.tab(b), g && i.verbose("Tab parameters found", d)), g && c)
                            {
                                return r ? (i.debug("Ignoring remote content on first tab load", v), S = !1, i.cache.add(n, A.html()), i.activate.all(v), e.proxy(s.onTabInit, A)(v, h, m), e.proxy(s.onTabLoad, A)(v, h, m)) : (i.activate.navigation(v), i.content.fetch(v, n)), !1;
                            }
                        ...
                        else
                        {
                            if (-1 != n.search("/"))
                            {
                                return i.error(x.missingTab, C, a, v), !1;
                            }
                            if (l = e("#" + n + ', a[name="' + n + '"]'), v = l.closest("[data-tab]").data("tab"), A = i.get.tabElement(v), l && l.size() > 0 && v)
                            {
                                return i.debug("No tab found, but deep anchor link present, opening parent tab"), i.activate.all(v), i.cache.read(v) || (i.cache.add(v, !0), i.debug("First time tab loaded calling tab init"), e.proxy(s.onTabInit, A)(v, h, m)), !1
                            }
                        }
                    })
                }, content: {
                    ...
                    }, defaultPath: function (e)
                    {
                        ...
                        if (a)
                        {
                            if (i.debug("Found default tab", a), w < s.maxDepth)
                            {
                                return w++, i.get.defaultPath(a);
                            }
                            i.error(x.recursion)
                        }
                        else
                        {
                            i.debug("No default tabs found for", e, f);
                        }
                        return w = 0, e
                ...
                {
                    if (i.debug("Changing setting", t, a), e.isPlainObject(t))
                    {
                        e.extend(!0, s, t);
                    }
                    else
                ...
                }, invoke: function (t, a, r)
                {
                    ...
                    return a = a || g, r = z || r, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), s = t.length - 1, e.each(t, function (a, o)
                    {
                        ...
                        else
                        {
                            ...
                            if (!e.isPlainObject(l[o]) || a == s)
                            {
                                return l[o] !== n ? (c = l[o], !1) : (i.error(x.method, t), !1);
                            }
                            l = l[o]
                        }
