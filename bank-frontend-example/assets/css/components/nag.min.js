            ...
            a = {
                ...
                }, clear: function ()
                {
                    ...
                    set: function (n, i)
                    {
                        ...
                        if ("localstorage" == d.storageMethod && o.localStorage !== t)
                        {
                            o.localStorage.setItem(n, i), a.debug("Value stored using local storage", n, i);
                        }
                        else
                        {
                            if (e.cookie === t)
                            {
                                return void a.error(f.noCookieStorage);
                            }
                ...
                {
                    if (a.debug("Changing setting", o, n), e.isPlainObject(o))
                    {
                        e.extend(!0, d, o);
                    }
                    else
                ...
                }, invoke: function (o, n, r)
                {
                    ...
                    return n = n || g, r = w || r, "string" == typeof o && u !== t && (o = o.split(/[\. ]/), s = o.length - 1, e.each(o, function (n, i)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                return u[i] !== t ? (c = u[i], !1) : (a.error(f.method, o), !1);
                            }
                            u = u[i]
                        }
