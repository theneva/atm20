        ...
        return s = {
            ...
            }, console: function (e)
            {
                if (e)
                {
                    ...
                    {
                        return void s.error(g.console);
                    }
                    s.debug("Restoring console function"), n.console = y.cache.console
                }
                else
                {
                    s.debug("Disabling console function"), y.cache.console = n.console, n.console = {
                        clear: function ()
                        {
                        }, error: function ()
                        {
            ...
            }, invoke: function (n, o, t)
            {
                ...
                return o = o || m, t = h || t, "string" == typeof n && l !== i && (n = n.split(/[\. ]/), a = n.length - 1, e.each(n, function (o, t)
                {
                    ...
                    else
                    {
                        ...
                        if (!e.isPlainObject(l[t]) || o == a)
                        {
                            return l[t] !== i ? (c = l[t], !1) : (s.error(g.method, n), !1);
                        }
                        l = l[t]
                    }
